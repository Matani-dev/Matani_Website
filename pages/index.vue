<template>
	<div>
		<header>
			...
			<h1 data-aos-duration="2000" class="gradient padding" data-aos="fade-up"><span>Receive Client Feedback with just one click.</span></h1>
			...
			<div class="input__wrapper" data-aos="fade-up" data-aos-duration="2000">
				<input v-model="email" type="text" placeholder="Enter your email address">
				<button @click="saveToNewsletter">Sign up for Beta</button> 
			</div>
		</header>

		<section class="content">
			<h2 data-aos="fade-up" data-aos-duration="1000">Client Feedback has never been easier.</h2>
		...
		<section class="cta">
			<h2 class="gradient padding"  data-aos="fade-up" data-aos-duration="1000"><span>Drop us a line or two, we are open for creative minds and collaborations!</span></h2>
			<a href="https://discord.gg/fNXV9xMc" target="_blank"  data-aos="fade-up" data-aos-duration="1000">
	...
	methods: {
		async saveToNewsletter() {
			if(this.validateEmail()) {
				this.$axios.$post(`https://emailoctopus.com/api/1.6/lists/${process.env.octopusListID}/contacts?api_key=${process.env.octopusAPIKey}&email_address=${this.email}`)
			}
		},
